import 'package:audio_book/generated/assets.dart';
...
class _AppAnimationSearchBarState extends State<AppAnimationSearchBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final hPadding = widget.horizontalPadding != null ? widget.horizontalPadding! * 2 : 0;
    final searchBarWidth = widget.searchBarWidth ?? MediaQuery.of(context).size.width - hPadding;
    return Padding(
      padding: EdgeInsets.symmetric(
          horizontal: widget.horizontalPadding ?? 0, vertical: widget.verticalPadding ?? 0),
      child: Container(
              ...
              children: [
                ...
                AnimatedOpacity(
                  ...
                  child: AnimatedContainer(
                    margin: _isSearching ? null : const EdgeInsets.only(left: 10),
                    curve: Curves.easeInOutCirc,
                    duration: duration,
                ...
                AnimatedOpacity(
                  ...
                  child: AnimatedContainer(
                    curve: Curves.easeInOutCirc,
                    duration: 300.milliseconds,
                    width: _isSearching ? searchBarWidth - 46 - (widget.horizontalPadding ?? 0 * 2) : 0,
...
class KCustomButton extends StatelessWidget {
  ...
  const KCustomButton(
      {super.key, required this.widget, required this.onPressed, this.radius, this.onLongPress});
    ...
    return ClipRRect(
        ...
        child: Material(
            ...
            child: InkWell(
                ...
                child: Padding(
                    padding: const EdgeInsets.symmetric(vertical: 0, horizontal: 0), child: widget))));
  }
}
...
class KBackButton extends StatelessWidget {
  ...
  const KBackButton({super.key, required this.previousScreen, required this.iconColor, required this.icon});
                ...
                onTap: () async {
                  previousScreen == null
                      ...
                      : Navigator.pushReplacement(
                          context, CupertinoPageRoute(builder: (context) => previousScreen!));
                },
                child: Padding(
                    padding: const EdgeInsets.all(3),
                    child: SizedBox(
